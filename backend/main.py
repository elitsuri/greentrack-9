...
GreenTrack: Environmental impact tracker with carbon footprint analytics
"""
...
app = FastAPI(
    title="greentrack",
    description="GreenTrack: Environmental impact tracker with carbon footprint analytics",
    version="1.0.0",
)
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "service": "greentrack"}
